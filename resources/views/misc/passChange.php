                    ...
                    <div class="container" style="color:#2C3E50">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3" >
                                ...
                                <form method="post" id="passwordForm" action="<?=$action_url?>"">
                                ...
                                <input type="password" class="input-lg form-control" name="confirm" id="password1"
                                ...
                                <input type="hidden" name="token" value="<?=$reset_password_code?>">
                                </form>
                            </div><!--/col-sm-6-->
                        </div><!--/row-->
                    </div>
